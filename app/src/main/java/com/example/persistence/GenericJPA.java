...
public class GenericJPA<T, Long> {
    ...
    //lo devuelvo como un Optional para gestinar si hay resultados o no
    ...
    //lo devuelvo como un Optional para gestinar si hay resultados o no
    public Optional<List<T>> findAllGenerico(){
        EntityManager em = ConfigJPA.getEntityManager();
        ...
        //lo convierto en un optional, le digo que sea nulo si no me consigue resultados
